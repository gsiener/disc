...
| minor | `20260810-a-band-on-a-match-bounded-by-score` | A richness band on a match bounded by SCORE fails when the game gets better, and reads as a regression |
