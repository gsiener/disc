...
import { DiscRuntime, type ThrowRequest, type TrailSample } from '../../src/entities/Disc.ts';
...
export function discRuntimeGoldens() {
  return {
    note:
      'Generated by tools/gen-goldens.ts from src/entities/Disc.ts (the DiscRuntime half; '
